            ...
            <xsl:when test="$stylesheet_url = 'NONE'">
                ...
                <!-- GENERAL CSS -->
					* {
					...
					.blue_box_no_back .payment_table_header .payment_means_code {
                        border-color: #A6C3D1;
					}

					.red_box_no_back .payment_table_header .payment_means_code {
                        border-color: #CDA1B6;
					}
                    ...
                    .items_table_body > .hide_content_input:checked + .items_table_body_holder + .items_table_body_small_screen_holder .document_lines_small_screen_additional_information_line .hide_content,
                    .items_table .hide_all_content_input:checked ~ .items_table_body .items_table_body_small_screen_holder .document_lines_small_screen_additional_information_line .hide_content {
                        min-height: 0;
                        height: 0;
                        opacity: 0;
                        display: block;
                    ...
                    .items_table_body_small_screen_holder {
                ...
                <!-- MEDIA QUERIES -->
                    ...
                    @media (max-width:992px) {
                        ...
                        .main_header .seller .seller_info  {
                            width: auto;
                            margin-right: 2em;
                        }

                        .main_header .seller .seller_contact {
                            width: auto;
                        }
                        <!-- /MAIN HEADER -->
                        ...
                        .document_lines_small_screen_additional_information_line:nth-child(1) {
                            <!-- width: 7%;
                            min-width: 40px -->
                            width: 25%;
                            min-width: 120px
                        }
                        .document_lines_small_screen_additional_information_line:nth-child(2) {
                            <!-- width: 93%;
                    ...
                    @media print {
                        ...
                        .items_table_body_holder > .items_table_body_data .hide_on_small_screen.item_line_additional_info {
                            display: block !important;
                        }
            ...
            <body>
                <div class="container">
                    <header class="main_header row">
                        <!-- SELLER -->
                        <div class="seller col-50 sm-col-100 margin-right-big">
                            <div class="row">
                                <div class="col-100">
                                    <p class="title">
                            ...
                            <div class="row">
                                ...
                                <div class="seller_contact col-50 margin-right-small">
                        ...
                        <!-- /SELLER -->
                        <div class="document_details col-50 sm-col-100 margin-right-big">
                            <!-- DOCUMENT DETAILS -->
                    ...
                    <div class="row buyer_and_due_dates_holder sm_screen_wrap_row">
                        <div class="buyer col-50 sm-col-100 margin-right-big">
                            <!-- BUYER -->
                            <xsl:if test="local-name(.)  = 'Invoice'">
                                <div class="blue_box">
                                    <p class="title">
                        ...
                        <xsl:if test="local-name(.) = 'Invoice'">
                            <div class="buyer_payment_info_holder col-50 sm-col-100 margin-right-big">
                                <div class="row">
                    ...
                    <xsl:if test="local-name(.) = 'Invoice'">
                        <br/>
                        <div class="row payment_means_and_descripton_holder sm_screen_wrap_row">
                            <xsl:choose>
                                <xsl:when test="cac:PaymentMeans != ''">
                                    <div class="payment_table col-50 sm-col-100 margin-right-big">
                                        <div class="blue_box_no_back">
                                            <xsl:for-each select="cac:PaymentMeans">
                                                <div class="payment_table_header row">
                                                    ...
                                                    <div class="payment_means_code col-50" data-name="payment_means_code">
                                                        <p>
                                                            ...
                                                            <xsl:choose>
                                                                ...
                                                                <xsl:variable name="codeNineIssuerIS" select="'9_issuerIS'" />
                                                                    <xsl:call-template name="PaymentMeansCode">
                                                                        <xsl:with-param name="PaymentCode" select="$codeNineIssuerIS"/>
                                                                    </xsl:call-template>
                                                                </xsl:when>
                                                                <xsl:otherwise>
                                            ...
                                            <xsl:if test="not(cac:AccountingSupplierParty/cac:Party/cac:PostalAddress/cac:Country/cbc:IdentificationCode) or (cac:AccountingSupplierParty/cac:Party/cac:PostalAddress/cac:Country/cbc:IdentificationCode !='IS')">
                                                <xsl:choose>
                                            ...
                                            <div class="payment_table_header row">
                                                ...
                                                <div class="payment_means_code col-50" data-name="payment_means_code">
                                                    <p>
                                                        [1]
                                                        <xsl:call-template name="PaymentMeansCode">
                                                            <xsl:with-param name="PaymentCode" select="1"/>
                                                        </xsl:call-template>
                                                    </p>
                                                </div>
                                            </div>
                            ...
                            <div class="blue_box_no_back description col-50 sm-col-100 margin-right-big">
                                <p>
                                    <small>
                                        <xsl:call-template name="UMZLabelName">
                                ...
                                <xsl:if test="cac:ReceiptDocumentReference/cbc:ID">
                                    <p>
                                        <small>
                                            ...
                                            <!-- Inserting Invoice Issue Date  -->
                                            <!-- <xsl:if test="cac:ReceiptDocumentReference/cbc:IssueDate != ''">
                                                [<xsl:value-of select="cac:ReceiptDocumentReference/cbc:IssueDate"/>]
                                            </xsl:if> -->
                                        </small>
                                    </p>
                                </xsl:if>
                                <xsl:if test="cac:OriginatorDocumentReference/cbc:ID">
                                    <p>
                                        <small>
                                            <b>
                                                <xsl:call-template name="UMZLabelName">
                                                    <xsl:with-param name="BT-ID" select="'UMZ-BT-075'"/>
                                                    <xsl:with-param name="Colon-Suffix" select="'true'"/>
                                                </xsl:call-template>
                                            </b>&#8201;
                                            ...
                                            <!-- Inserting Invoice Issue Date  -->
                                            <!-- <xsl:if test="cac:OriginatorDocumentReference/cbc:IssueDate != ''">
                                                [<xsl:value-of select="cac:OriginatorDocumentReference/cbc:IssueDate"/>]
                                            </xsl:if> -->
                                        </small>
                                    </p>
                                </xsl:if>
                                <xsl:if test="cac:ContractDocumentReference/cbc:ID">
                                    <p>
                                        <small>
                                            ...
                                            <!-- Inserting Invoice Issue Date  -->
                                            <!-- <xsl:if test="cac:ContractDocumentReference/cbc:IssueDate != ''">
                                                [<xsl:value-of select="cac:ContractDocumentReference/cbc:IssueDate"/>]
                                            </xsl:if> -->
                                        </small>
                                    </p>
                                </xsl:if>
                                <xsl:if test="cac:ProjectReference/cbc:ID">
                                    <p>
                                        <small>
                                            ...
                                            <!-- Inserting Invoice Issue Date  -->
                                            <!-- <xsl:if test="cac:ProjectReference/cbc:IssueDate != ''">
                                                [<xsl:value-of select="cac:ProjectReference/cbc:IssueDate"/>]
                                            </xsl:if> -->
                                        </small>
                                    </p>
                                </xsl:if>
                    ...
                    <xsl:if test="local-name(.) = 'CreditNote'">
                        ...
                        <div class="row">
                                        ...
                                        <div class="red_box_no_back">
                                            <xsl:for-each select="cac:PaymentMeans">
                                                <div class="payment_table_header">
                                                    ...
                                                    <div class="payment_means_code" data-name="payment_means_code">
                                                        <p>
                                                            [<xsl:apply-templates select="cbc:PaymentMeansCode"/>]
                                                            <xsl:choose>
                                                                <xsl:when test="(../cac:AccountingSupplierParty/cac:Party/cac:PostalAddress/cac:Country/cbc:IdentificationCode ='IS') and (cbc:PaymentMeansCode = 9)">
                            ...
                            <div class="red_box_no_back credit_note_description col-50 margin-right-big">
                                ...
                                <xsl:if test="cac:AdditionalDocumentReference !=''">
                                    <xsl:apply-templates select="cac:AdditionalDocumentReference[cbc:DocumentTypeCode='50']" mode="InvoicedObject"/>
                                </xsl:if>
                            </div>
                        </div>
                    </xsl:if>
                    ...
                    <br/>
                    <!-- Start VAT Breakdown: -->
                    <div class="row sm_screen_wrap_reverse_row">
                        <div class="tax_table col-50 sm-col-100 margin-right-big">
                            <xsl:if test="local-name(.)  = 'Invoice'">
                                <div class="blue_box_no_back">
                        ...
                        <!-- Start Tax Amount: -->
                        <div class="tax_amount col-50 sm-col-100 margin-right-big">
                            <div class="tax_amount_content">
                            <!-- Start Header Allowance Charge: -->
                            <xsl:for-each select="cac:AllowanceCharge">
                                ...
                                <xsl:if test="cbc:ChargeIndicator = 'true'">
                                    <div class="col-66">
                                        <p class="text_right">
                                            <xsl:call-template name="UMZLabelName">
                                                <xsl:with-param name="BT-ID" select="'UMZ-BT-084'"/>
                                                <xsl:with-param name="Colon-Suffix" select="'false'"/>
                                            </xsl:call-template> 
                                            <xsl:value-of select="cbc:AllowanceChargeReason" />[<xsl:value-of select="cac:TaxCategory/cbc:ID" /><xsl:value-of select="cac:TaxCategory/cbc:Percent" />]:
                                        </p>
                                    </div>
                                ...
                                <div class="col-66">
                                        <p class="text_right">
                                        <xsl:call-template name="UMZLabelName">
                                                <xsl:with-param name="BT-ID" select="'UMZ-BT-085'"/>
                                                <xsl:with-param name="Colon-Suffix" select="'false'"/>
                                            </xsl:call-template> 
                                            <xsl:value-of select="cbc:AllowanceChargeReason" />[<xsl:value-of select="cac:TaxCategory/cbc:ID" /><xsl:value-of select="cac:TaxCategory/cbc:Percent" />]:
                                        </p>
                                    ...
                                    <div class="col-33">
                                        <p class="text_right">
                                            <b>
                                                ...
                                                <xsl:value-of select="sum(cac:LegalMonetaryTotal/cbc:TaxInclusiveAmount | cac:LegalMonetaryTotal/cbc:PayableRoundingAmount)"/>
                                                </xsl:variable>
                                                <small>
                                                    <xsl:value-of select="cbc:DocumentCurrencyCode" />&#8201;
                                                </small>
                    ...
                    <xsl:if test="local-name(.)  = 'Invoice'">
                        <div class="row xs_screen_wrap_row">
                            <div class="delivery_location col-50 xs-col-100 margin-right-big">
                            ...
                            <div class="col-50 xs-col-100 margin-right-big">
                    ...
                    <div class="row xs_screen_wrap_row">
                        <div class="seller_information col-50 xs-col-100 margin-right-big">
                            <xsl:if test="local-name(.)  = 'Invoice'">
                                <p class="blue_title">
                                    <xsl:call-template name="LabelName">
                        ...
                        <div class="buyer_information col-50 xs-col-100 margin-right-big">
                            <xsl:if test="local-name(.)  = 'Invoice'">
                                <p class="blue_title">
                                    <xsl:call-template name="UMZLabelName">
                                ...
                                <xsl:if test="(cac:AdditionalDocumentReference !='') and (cac:AdditionalDocumentReference[not(cbc:DocumentDescription = 'EINDAGI') and not(cbc:DocumentTypeCode = '71')])">
                            ...
                            <xsl:if test="local-name(.)  = 'CreditNote'">
                                ...
                                <br/>
                                <!-- Additional Supporting Documents -->
                                <xsl:if test="(cac:AdditionalDocumentReference !='') and (cac:AdditionalDocumentReference[not(cbc:DocumentDescription = 'EINDAGI') and not(cbc:DocumentTypeCode = '71') and not(cbc:DocumentTypeCode = '50')])">
                                    <div class="supporting_documents">
                                        <p class="red_title">
                                            <xsl:call-template name="LabelName">
                                                <xsl:with-param name="BT-ID" select="'BG-24'"/>
